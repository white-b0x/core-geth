...
const (
	...
	BlockRLPSizeCap uint64 = 10*1024*1024 - 2*1024*1024 // EIP-7934: Max RLP-encoded block size (10 MiB - 2 MiB safety margin = ~9.5 MiB).
	...
	Bls12381G1AddGas          uint64 = 375   // Price for BLS12-381 elliptic curve G1 point addition (EIP-2537 final)
	Bls12381G1MulGas          uint64 = 12000 // Price for BLS12-381 elliptic curve G1 multi-scalar-multiplication per-pair base
	Bls12381G2AddGas          uint64 = 600   // Price for BLS12-381 elliptic curve G2 point addition (EIP-2537 final)
	Bls12381G2MulGas          uint64 = 22500 // Price for BLS12-381 elliptic curve G2 multi-scalar-multiplication per-pair base
	Bls12381PairingBaseGas    uint64 = 37700 // Base gas price for BLS12-381 elliptic curve pairing check (EIP-2537 final)
	Bls12381PairingPerPairGas uint64 = 32600 // Per-point pair gas price for BLS12-381 elliptic curve pairing check (EIP-2537 final)
	Bls12381MapG1Gas          uint64 = 5500  // Gas price for BLS12-381 mapping field element to G1 operation
	Bls12381MapG2Gas          uint64 = 23800 // Gas price for BLS12-381 mapping field element to G2 operation (EIP-2537 final)
...
// Bls12381G1MultiExpDiscountTable is the gas discount table for BLS12-381 G1 multi exponentiation operation (EIP-2537 final)
...
// Bls12381G2MultiExpDiscountTable is the gas discount table for BLS12-381 G2 multi exponentiation operation (EIP-2537 final)
