...
func (c *CoreGethChainConfig) GetEIP7934Transition() *uint64 {
	return bigNewU64(c.EIP7934FBlock)
}

func (c *CoreGethChainConfig) SetEIP7934Transition(n *uint64) error {
	c.EIP7934FBlock = setBig(c.EIP7934FBlock, n)
	return nil
}
