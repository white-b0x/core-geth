...
var BLSPrecompileAddrs = []string{
	...
	"0x000000000000000000000000000000000000000c", // G1Mul
	"0x000000000000000000000000000000000000000d", // G1MultiExp
	"0x000000000000000000000000000000000000000e", // G2Add
	"0x000000000000000000000000000000000000000f", // G2Mul
	"0x0000000000000000000000000000000000000010", // G2MultiExp
	"0x0000000000000000000000000000000000000011", // Pairing
	"0x0000000000000000000000000000000000000012", // MapG1
	"0x0000000000000000000000000000000000000013", // MapG2
}
